...
REM Build public/index.html from src/ files (browser-only; core/ is server-side)
REM Usage: build.cmd

set "SCRIPT_DIR=%~dp0"
set "SRC=%SCRIPT_DIR%src"
set "OUT=%SCRIPT_DIR%public\index.html"
...
REM Use PowerShell to assemble the file line-by-line
